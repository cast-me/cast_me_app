...
const CastBase$json = const {
  ...
  '2': const [
    ...
    const {'1': 'reply_to', '3': 10, '4': 1, '5': 9, '10': 'replyTo'},
...
final $typed_data.Uint8List castBaseDescriptor = $convert.base64Decode('');
